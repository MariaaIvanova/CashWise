...
const defaultLessons: Lesson[] = [
  {
    ...
    description:
      "Научете за данъка върху добавената стойност, кога се прилага и какви са ставките.",
    progress: 0,
    isPremium: false,
          ...
          questions: [
            {
              ...
              correctAnswers: [3],
              explanation:
                "В България основната ставка на ДДС е 20%, а намалената ставка е 9%. Намалената ставка се прилага за определени стоки и услуги като книги и ресторантьорски услуги.",
            },
            {
              question:
                "Вярно ли е, че за фирмите, които надвишават определен годишен оборот регистрацията по ДДС е задължителна?",
              type: "single",
              options: ["Вярно", "Грешно"],
              correctAnswers: [0],
              explanation:
                "Да, това е вярно. От 2024 г. фирмите с годишен оборот над 100 000 лв. са задължени да се регистрират по ДДС. Това е част от мерките за подобряване на данъчната дисциплина.",
            },
            {
              question:
                "Къде отива данъкът върху добавената стойност, който плащаме?",
              type: "single",
              options: [
              ...
              correctAnswers: [2],
              explanation:
                "Въпреки че потребителят плаща ДДС при покупката, данъкът се отчита и превежда към държавата от фирмата-продавач. Това е част от механизма за контрол на данъчните постъпления.",
            },
            {
              question:
                "Колко е нормалното ДДС на даден продукт, който струва 83,33 лв.?",
              type: "single",
              options: ["12,54 лв.", "16,67 лв.", "14,74 лв.", "23,33 лв."],
              correctAnswers: [1],
              explanation:
                "При основна ставка от 20%, ДДС се изчислява като 20% от цената без ДДС. В този случай, ако крайната цена е 100 лв. (83,33 лв. + 16,67 лв. ДДС), то ДДС е 16,67 лв.",
            },
          ],
        },
      },
  ...
  },
  {
    ...
    description:
      "Научете за различните видове кредити, техните характеристики и кога да ги използвате.",
    progress: 0,
    isPremium: false,
          ...
          questions: [
            {
              ...
              correctAnswers: [1],
              explanation:
                "Потребителският кредит е предназначен за по-малки покупки като техника, мебели или други потребителски стоки.",
            },
            {
              ...
              correctAnswers: [2],
              explanation:
                "При забавяне на плащанията банките обикновено начисляват наказателни лихви, които значително увеличават общата сума за изплащане.",
            },
            {
              question:
                "Кои от изброените характеристики се отнасят за бързите кредити?",
              type: "multiple",
              options: [
                "Лесно достъпни",
              ...
              explanation:
                "Бързите кредити са лесно достъпни, но имат висока лихва и са подходящи само при извънредни случаи. Те не изискват ипотека и имат кратък срок на погасяване.",
            },
            {
              question:
                "Кой от изброените кредити обикновено изисква най-дълъг срок на погасяване?",
              type: "single",
              options: ["Потребителски", "Бърз", "Ипотечен"],
              correctAnswers: [2],
              explanation:
                "Ипотечните кредити обикновено имат най-дълъг срок на погасяване – от 20 до 30 години, поради големия размер на заеманата сума.",
            },
            {
              ...
              correctAnswers: [0],
              explanation:
                "Лихвата е допълнителната сума, която се плаща за използването на кредита. Това е цената, която банката таксува за предоставянето на кредита.",
            },
            {
              ...
              correctAnswers: [1],
              explanation:
                "Вноската е месечната сума, която трябва да плащате за погасяване на кредита. Тя включва част от главницата и лихвата.",
            },
            {
              ...
              correctAnswers: [2],
              explanation:
                "Гратисният период е времето, през което не се изисква плащане на лихва по кредита. Това е период, когато можете да използвате кредита без да плащате допълнителни лихви.",
            },
            {
              ...
              correctAnswers: [1],
              explanation:
                "Основният риск при бързите кредити е високата лихва, която може да доведе до затруднения при изплащането и задлъжняване.",
            },
            {
              question:
                "Кое от следните твърдения е вярно за потребителските кредити?",
              type: "single",
              options: [
              ...
              correctAnswers: [2],
              explanation:
                "Потребителските кредити обикновено са в размер до 10 000 лв. и не изискват ипотека като обезпечение.",
            },
          ],
        },
      },
  ...
  },
  {
    ...
    description:
      "Научете за различните видове инвестиции, техните характеристики и кога да ги използвате.",
    progress: 0,
    isPremium: false,
    ...
    topics: [
      {
        ...
        quiz: {
          ...
          questions: [
            {
              question:
                "Кои от следните твърдения са верни за инвестирането в имоти?",
              type: "multiple",
              options: [
              ...
              correctAnswers: [0, 1, 3],
              explanation:
                "Инвестицията в имоти изисква значителен първоначален капитал, може да генерира доход чрез наем и позволява печалба при препродажба. Тя е подходяща и за дългосрочни вложения.",
            },
            {
              ...
              correctAnswers: [1],
              explanation:
                "Основният риск при инвестирането в акции е потенциалната загуба на пари, ако компанията, в която сте инвестирали, се провали или нейните акции загубят стойност.",
            },
            {
              ...
              correctAnswers: [1],
              explanation:
                "Облигациите са по-сигурна инвестиция в сравнение с акциите, но обикновено носят по-ниска възвръщаемост. Те предлагат фиксирана лихва и са подходящи за консервативни инвеститори.",
            },
            {
              question:
                "Какво може да се случи, ако компанията, в която си инвестирал чрез акции, започне да губи пари?",
              type: "single",
              options: [
              ...
              correctAnswers: [1],
              explanation:
                "Когато компания започне да губи пари, стойността на нейните акции обикновено намалява, което може да доведе до загуба на част или цялата инвестиция.",
            },
            {
              question:
                "Какъв е основният източник на доход при инвестиция в имоти?",
              type: "single",
              options: [
                "От дивиденти",
              ...
              correctAnswers: [1],
              explanation:
                "Основният източник на доход при инвестиция в имоти идва от наемите, които получавате от наемателите, или от печалбата при препродажба на имота.",
            },
            {
              question: "Коя инвестиция обикновено се смята за най-сигурна?",
              type: "single",
              options: ["Акции", "Облигации", "Имоти"],
              correctAnswers: [1],
              explanation:
                "Облигациите обикновено се смятат за най-сигурната инвестиция от трите основни вида, тъй като предлагат фиксирана лихва и по-нисък риск от загуба на капитал.",
            },
            {
              question:
                "Коя от следните инвестиции гарантира висока и сигурна печалба?",
              type: "single",
              options: [
              ...
              correctAnswers: [2],
              explanation:
                "Всяка инвестиция носи определен риск. Дори най-сигурните инвестиции не гарантират висока печалба. Важно е да разберете рисковете и да диверсифицирате инвестициите си.",
            },
            {
              question:
                "Иван купува акции на технологична фирма и следи дали ще се покачат цените. Какъв вид инвестиция прави Иван?",
              type: "single",
              options: [
                "Инвестиция в акции",
              ...
              correctAnswers: [0],
              explanation:
                "Иван инвестира в акции, тъй като купува дял от технологична компания. Това е инвестиция в акции, която може да носи потенциална печалба при повишаване на цената на акциите.",
            },
            {
              question:
                "Мария дава пари на държавата и получава фиксирана лихва всяка година. Какъв вид инвестиция прави Мария?",
              type: "single",
              options: [
                "Инвестиция в акции",
                "Инвестиция в облигации",
              ...
              correctAnswers: [1],
              explanation:
                "Мария инвестира в облигации, тъй като дава заем на държавата срещу фиксирана лихва. Това е по-сигурна инвестиция, която носи предвидим доход.",
            },
            {
              question:
                "Петър купува апартамент и го отдава под наем. Какъв вид инвестиция прави Петър?",
              type: "single",
              options: [
                "Инвестиция в акции",
                "Инвестиция в облигации",
              ...
              correctAnswers: [2],
              explanation:
                "Петър инвестира в имоти, тъй като купува недвижим имот за наем. Това е инвестиция, която може да носи стабилен доход от наеми и потенциална печалба при препродажба.",
            },
          ],
        },
      },
  ...
  },
  {
    ...
    description:
      "Научете как да управлявате парите си разумно, да спестявате и да планирате финансовото си бъдеще.",
    progress: 0,
    isPremium: false,
    ...
    topics: [
      {
        title: "Спестяване и финансово планиране",
        content:
          "Да спестяваш пари не означава да се лишаваш. Това означава да мислиш за бъдещето си. Дори малки суми всеки месец могат да направят голяма разлика след време. Финансовото планиране е като план за пътуване – казваш си къде искаш да стигнеш и как ще стигнеш до там.\n\nЗащо е важно да спестяваме?\n\nЗа спешни случаи (пример: неочакван разход за лекар)\nЗа по-големи цели (телефон, лаптоп, образование, кола)\nЗа спокойствие – знаеш, че имаш резерв",
        image:
          "https://images.unsplash.com/photo-1579621970795-87facc2f976d?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80",
        ...
        quiz: {
          ...
          questions: [
            {
              question:
                "Кое от следните най-точно описва целта на финансовото планиране?",
              type: "single",
              options: [
              ...
              correctAnswers: [1],
              explanation:
                "Финансовото планиране е процес на изготвяне на стратегия за управление на личните финанси, фокусирана върху постигането на конкретни финансови цели.",
            },
            {
              question:
                "Кои от изброените навици могат да подпомогнат изграждането на устойчива практика за спестяване?",
              type: "multiple",
              options: [
              ...
              correctAnswers: [0, 1],
              explanation:
                "Анализът на разходите и придържането към списък при покупки са навици, които помагат за контрол на разходите и ефективно спестяване.",
            },
            {
              ...
              correctAnswers: [0],
              explanation:
                "Финансовата сигурност се постига чрез създаване на буфер за неочаквани събития, което е една от основните цели на спестяването.",
            },
            {
              question:
                "Каква е целта на спестяването за осъществяване на дългосрочна цел?",
              type: "single",
              options: [
                "Създаване на буфер за неочаквани събития",
                "Натрупване на средства за предстояща голяма покупка",
              ...
              correctAnswers: [1],
              explanation:
                "Осъществяването на дългосрочна цел чрез спестяване включва натрупване на средства за предстояща голяма покупка.",
            },
            {
              question:
                "Каква е целта на спестяването за психологическо спокойствие?",
              type: "single",
              options: [
                "Създаване на буфер за неочаквани събития",
                "Натрупване на средства за предстояща голяма покупка",
              ...
              correctAnswers: [2],
              explanation:
                "Психологическото спокойствие се постига чрез намаляване на стреса, което е възможно благодарение на контрола върху финансите.",
            },
            {
              question:
                'Какво се подразбира под израза "плащай първо на себе си" в контекста на спестяването?',
              type: "single",
              options: [
              ...
              correctAnswers: [1],
              explanation:
                '"Плащането първо на себе си" означава отделяне на фиксиран процент от дохода за бъдещи цели, преди останалите разходи.',
            },
            {
              question:
                "Кои ситуации биха могли да се разглеждат като примери за нефункционално управление на личните финанси?",
              type: "multiple",
              options: [
              ...
              correctAnswers: [0, 2],
              explanation:
                "Покупката на скъпи стоки само поради намаление и прекомерната употреба на пари без отчет са примери за лошо финансово управление.",
            },
            {
              question:
                "Кое от следните е стратегическо поведение за избягване на ненужни разходи?",
              type: "single",
              options: [
              ...
              correctAnswers: [1],
              explanation:
                "Изграждането на навик за отложено вземане на решение при покупки е стратегическо поведение за избягване на ненужни разходи.",
            },
            {
              question:
                "Кое твърдение най-добре изразява ползата от спестяването дори на малки суми?",
              type: "single",
              options: [
            ...
            },
            {
              ...
              correctAnswers: [0],
              explanation:
                "Изчакването преди покупка води до намаляване на импулсивните разходи.",
            },
            {
              question:
                "Какъв е резултатът от воденето на разходен дневник чрез приложение?",
              type: "single",
              options: [
                "Намаляване на импулсивните разходи",
                "По-добър контрол върху разходите",
              ...
              correctAnswers: [1],
              explanation:
                "Воденето на разходен дневник чрез приложение води до по-добър контрол върху разходите.",
            },
            {
              question:
                "Какъв е резултатът от редовното спестяване на фиксиран процент?",
              type: "single",
              options: [
                "Намаляване на импулсивните разходи",
                "По-добър контрол върху разходите",
              ...
              correctAnswers: [2],
              explanation:
                "Редовното спестяване на фиксиран процент води до натрупване на финансова стабилност и независимост.",
            },
          ],
        },
      },
  ...
  },
  {
    ...
    description:
      "Научете за различните видове банкови депозити, техните характеристики и лихвени проценти.",
    progress: 0,
    isPremium: false,
    ...
    topics: [
      {
        ...
        quiz: {
          ...
          questions: [
            {
              question:
                "Кое от следните най-точно описва основното предимство на срочния депозит спрямо спестовния?",
              type: "single",
              options: [
              ...
              correctAnswers: [1],
              explanation:
                "Основното предимство на срочния депозит е по-високата лихва, която се получава при спазване на договорения срок.",
            },
            {
              ...
              correctAnswers: [0, 2],
              explanation:
                "Спестовният депозит се характеризира със свободен достъп до парите и по-ниска лихва в сравнение със срочния депозит.",
            },
            {
              ...
              correctAnswers: [0],
              explanation:
                "Спестовният депозит се характеризира с достъпност по всяко време, но предлага по-ниска лихва.",
            },
            {
              ...
              correctAnswers: [1],
              explanation:
                "Срочният депозит предлага по-висока лихва, но изисква ангажимент за определен срок.",
            },
            {
              ...
              correctAnswers: [2],
              explanation:
                "Онлайн депозитът се характеризира с управление чрез интернет и често предлага по-добри условия.",
            },
            {
              question:
                "Кое от следните действия може да доведе до загуба на лихва при срочен депозит?",
              type: "single",
              options: [
              ...
              correctAnswers: [1],
              explanation:
                "При срочен депозит, тегленето на средства преди края на договорения срок може да доведе до загуба на лихва.",
            },
            {
              question:
                "Кои са възможни причини онлайн депозитите да предлагат по-добри условия?",
              type: "multiple",
              options: [
              ...
              correctAnswers: [0, 2],
              explanation:
                "Онлайн депозитите често предлагат по-добри условия поради по-ниските разходи за банката и автоматизираните процеси.",
            },
            {
              ...
              correctAnswers: [1],
              explanation:
                "Лихвите по депозитите могат да варират в зависимост от срока, банката и вида на депозита.",
            },
            {
              ...
              correctAnswers: [0],
              explanation:
                "Срочният депозит предлага по-висока възвращаемост при спазване на ангажимента за определен срок.",
            },
            {
              ...
              correctAnswers: [1],
              explanation:
                "Онлайн депозитът позволява лесно управление от всяка точка чрез интернет.",
            },
            {
              question:
                "Какво е потенциалното предимство на спестовния депозит?",
              type: "single",
              options: [
                "По-висока възвращаемост при ангажимент",
                "Лесно управление от всяка точка",
              ...
              correctAnswers: [2],
              explanation:
                "Спестовният депозит предлага незабавен достъп до средства при нужда.",
            },
            {
              question:
                "Кое от следните е вярно за онлайн депозитите в сравнение със стандартните срочни депозити?",
              type: "single",
              options: [
              ...
              correctAnswers: [2],
              explanation:
                "Онлайн депозитите обикновено предлагат по-добри условия поради по-ниските разходи за банката за обслужване.",
            },
          ],
        },
      },
  ...
  },
  {
    ...
    description:
      "Научете различни методи за управление на личните финанси и създаване на ефективен бюджет.",
    progress: 0,
    isPremium: false,
          ...
          questions: [
            {
              ...
              correctAnswers: [2],
              explanation:
                "Основната цел на личния бюджет е да контролира разпределението на приходите и да осигури възможност за спестяване, като балансира между различните нужди и желания.",
            },
            {
              question:
                "Кои от следните елементи са основни при изготвянето на личен бюджет?",
              type: "multiple",
              options: [
              ...
              explanation:
                "При изготвянето на личен бюджет е важно да се изчислят всички доходи, да се проследяват разходите и да се определи сума за спестяване или инвестиция.",
            },
            {
              ...
              correctAnswers: [0],
              explanation:
                "Методът 50/30/20 се характеризира с ясно разпределение на доходите по три основни групи: нужди (50%), желания (30%) и спестяване (20%).",
            },
            {
              ...
              correctAnswers: [1],
              explanation:
                "Методът с пликове се характеризира с категоризиране на разходите със строго ограничение за всяка категория.",
            },
            {
              question:
                "Каква е основната характеристика на zero-based бюджета?",
              type: "single",
              options: [
                "Ясно разпределение на доходите по три основни групи",
                "Категоризиране на разходите със строго ограничение",
              ...
              correctAnswers: [2],
              explanation:
                "Zero-based бюджетът се характеризира с предварително и целево разпределение на всеки лев от дохода.",
            },
            {
              question:
                "Кое поведение най-добре съответства на принципите на zero-based бюджетиране?",
              type: "single",
              options: [
              ...
              correctAnswers: [2],
              explanation:
                "Zero-based бюджетирането изисква предварително задаване на цел за всяка част от дохода, включително спестяванията.",
            },
            {
              question:
                "Кои предимства предлага методът с пликове (или виртуални пликове)?",
              type: "multiple",
              options: [
              ...
              correctAnswers: [0, 2, 3],
              explanation:
                "Методът с пликове предлага предимства като ограничаване на харченето по категории, подобряване на самодисциплината и планиране на разходите на база налични средства.",
            },
            {
              question:
                "Коя от следните ситуации показва грешно прилагане на метода 50/30/20?",
              type: "single",
              options: [
              ...
              correctAnswers: [2],
              explanation:
                "Грешното прилагане на метода 50/30/20 е когато се спестява само 5% вместо предвидените 20%, а останалите 15% се използват за други разходи.",
            },
            {
              question:
                "Какво е предназначението на 50% от дохода според метода 50/30/20?",
              type: "single",
              options: [
              ...
              correctAnswers: [0],
              explanation:
                "Според метода 50/30/20, 50% от дохода се използват за основни нужди като наем, транспорт и храна.",
            },
            {
              question:
                "Какво е предназначението на 30% от дохода според метода 50/30/20?",
              type: "single",
              options: [
                "Основни нужди като наем и транспорт",
                "Желания и развлечения",
              ...
              correctAnswers: [1],
              explanation:
                "Според метода 50/30/20, 30% от дохода се използват за желания и развлечения.",
            },
            {
              question:
                "Какво е предназначението на 20% от дохода според метода 50/30/20?",
              type: "single",
              options: [
                "Основни нужди като наем и транспорт",
                "Желания и развлечения",
              ...
              correctAnswers: [2],
              explanation:
                "Според метода 50/30/20, 20% от дохода се използват за спестяване или изплащане на дългове.",
            },
            {
              ...
              correctAnswers: [2],
              explanation:
                "Zero-based бюджетът изисква планиране на всеки лев от приходите, включително спестяванията, като нищо не остава неразпределено.",
            },
          ],
        },
      },
  ...
  },
  {
    ...
    description:
      "Научете практични съвети за ефективно спестяване и избягване на ненужни разходи.",
    progress: 0,
    isPremium: false,
...
const HomeScreen: React.FC<HomeScreenProps> = ({ navigation }) => {
  ...
  const loadUserData = async (isRetry: boolean = false) => {
    try {
      if (!isRetry) {
        setLoading(true);
        setError(null);
      ...
      if (profileError?.code === "PGRST116") {
        ...
        const { error: createError } = await supabase.from("profiles").insert({
          id: user.id,
          name: user.user_metadata?.full_name || "Потребител",
          avatar_url: null,
          age: null,
          interests: [],
      ...
      const { data: streakInfo, error: streakError } =
        await database.getStreakInfo(user.id);
      ...
      const progressMap = (progressData || []).reduce(
        (acc: { [key: string]: UserProgress }, progress: UserProgress) => {
      ...
      const sortedLessons = [...updatedLessons].sort((a, b) => {
        if (a.progress === b.progress) {
          return (
            defaultLessons.findIndex((l) => l.id === a.id) -
            defaultLessons.findIndex((l) => l.id === b.id)
          );
        }
  ...
  const checkPreviousAttempts = async () => {
    ...
    try {
      ...
      const { data: attempts, error: attemptsError } =
        await database.getQuizAttempts(user.id);
  ...
  const renderLessonCard = (lesson: Lesson) => {
    const handleMarkAsCompleted = async () => {
      try {
        ...
        setLessons((prevLessons) =>
          prevLessons.map((l) =>
            l.id === lesson.id ? { ...l, progress: 1 } : l
          )
        );

        // Show success message
        Alert.alert("Успех!", "Урокът е маркиран като завършен.", [
          { text: "OK" },
        ]);
      } catch (err) {
    ...
    const isSpecialSavingLesson =
      lesson.id === "10" && lesson.title === "Как да спестяваме ефективно";
  ...
  const renderSkeletonLoader = () => (
    <Animated.View style={[styles.container, { opacity: fadeAnim }]}>
        ...
        <View style={styles.skeletonStats}>
          <View style={styles.skeletonStatItem}>
            ...
            <View
              style={[
                styles.skeletonText,
                { width: 40, height: 20, marginTop: 4 },
              ]}
            />
          </View>
          <View style={styles.skeletonStatItem}>
      ...
      {[1, 2, 3].map((_, index) => (
        <Surface
          key={index}
          style={[styles.lessonCard, styles.skeletonContainer]}
        >
          <View style={styles.skeletonLessonHeader}>
            ...
            <View style={styles.skeletonLessonInfo}>
              ...
              <View
                style={[
                  styles.skeletonText,
                  { width: 250, height: 16, marginTop: 8 },
                ]}
              />
            </View>
          </View>
    ...
    <View style={styles.mainContainer}>
      ...
      >
          ...
          >
            <View style={styles.challengesInnerContent}>
              ...
              <Text style={styles.challengesDescription}>
                Участвайте в ежедневни предизвикателства и печелете допълнителни
                точки
              </Text>
              <TouchableOpacity
        ...
        <View style={styles.lessonsSection}>
          <Text style={styles.sectionTitle}>Финансово образование</Text>
...
const styles = StyleSheet.create({
  ...
  heroGradient: {
    ...
    padding: Math.min(SCREEN_WIDTH * 0.04, 24),
  },
  heroContent: {
    width: "100%",
    gap: 8,
  ...
  statPill: {
    ...
    padding: Math.min(SCREEN_WIDTH * 0.025, 8),
    borderRadius: 16,
    height: 36,
    flex: 1,
    maxWidth: "48%",
  ...
  statLabel: {
    fontSize: Math.min(SCREEN_WIDTH * 0.03, 13),
    fontFamily: Platform.OS === "web" ? undefined : "System",
    fontWeight: "500",
    color: "rgba(255, 255, 255, 0.9)",
